...
[Snipaste：好用的截图贴图工具（windows自带截图win+shift+s）](https://zh.snipaste.com/)
...
win11 跳过用户激活 ：shift+F10 打开 cmd后 \`start ms-cxh:localonly\`
...
[以下为微软官方教程内容](https://learn.microsoft.com/zh-cn/windows/wsl/install)
